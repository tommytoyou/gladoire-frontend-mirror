...
const Welcome = () => {
    return (
        <div>
            ...
            <ul>
                <li>First we experience a detachment from the external world and a consciousness of joy and ease, </li> 
                <li>Then a concentration, with suppression of reasoning and investigation, </li>
